...
export default function TextGenerator() {
  ...
  const { generatedText, textgenerator } = useResponseStore();

  const handleGenerate = () => {
    textgenerator(input); // call backend
  };
  return (
    <div className="min-h-screen bg-white flex flex-col items-center p-6 overflow-hidden">
      ...
      <h1 className="text-3xl font-bold text-sky-600 mb-2">
        AutoGenie - Text Generator
      </h1>
      <p className="text-gray-500 mb-6">Generate content instantly using AI</p>
