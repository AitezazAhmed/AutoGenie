...
const LoginPage = () => {
  ...
  return (
    <div className="flex min-h-full flex-col justify-center px-6 py-5 lg:px-8 ">
        ...
        <button type="submit" className="flex w-full justify-center rounded-md bg-indigo-600 px-3 py-1.5 text-sm/6 font-semibold text-white shadow-xs hover:bg-indigo-500 focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-indigo-600" disabled={isLoggingIn}>
                 {isLoggingIn ? (
                   <>
              ...
              <Link to={"/signup"}>
            <div className="space-x-3"> <span>Create a account?</span><span className="text-indigo-600"><a className="hover:underline ">Sign Up</a></span></div> </Link>
